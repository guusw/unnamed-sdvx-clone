...
bool GUIRenderer::Init(class OpenGL* gl, class DesktopWindow* window)
{
	assert(gl);
	m_gl = gl;
...
void GUIRenderer::SetWindow(DesktopWindow* window)
{
	if(m_window)
	{
...
DesktopWindow* GUIRenderer::GetWindow() const
{
	return m_window;
}
